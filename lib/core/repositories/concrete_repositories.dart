...
class InventoryRepository implements IInventoryRepository {
  ...
  Future<List<InventoryModel>> getLowStock() async {
    // Firestore no permite comparar dos campos del mismo documento
    // (cantidadActual <= cantidadMinima) en una query, así que se obtienen
    // los ítems y se filtra en cliente usando la regla de negocio del modelo.
    final snapshot = await _firestore
        .collection(_collection)
